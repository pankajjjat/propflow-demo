    ...
    <section className="py-28">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="card-elevated p-10 md:p-16 text-center max-w-4xl mx-auto"
        >
          ...
          <blockquote className="text-xl md:text-2xl font-medium text-surface-900 leading-relaxed mb-6">
            &ldquo;PropFlow saved me 3 hours every single day. My clients upload documents 
            directly from WhatsApp. I haven&apos;t chased a single document in 2 months.&rdquo;
          </blockquote>
          <div className="flex items-center justify-center gap-3">
            <div className="w-10 h-10 rounded-full bg-surface-200" />
            <div className="text-left">
              <div className="font-semibold text-surface-900">Vikram Singh</div>
              <div className="text-sm text-surface-400">Property Broker, Jaipur</div>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl font-bold tracking-tight text-surface-900 mb-4">
              A ₹5,000 Cr Market Waiting for a Solution
            </h2>
            <p className="text-surface-500 leading-relaxed mb-6">
              India has 1.5M+ property brokers. Each broker manages 15-30 deals per year. 
              Every deal involves 15-25 documents. That&apos;s 500M+ documents flowing through 
              WhatsApp every year with zero workflow automation.
            </p>
            <ul className="space-y-3">
              {[
                '1.5M+ property brokers in India',
                '₹12L average annual SaaS spend potential per broker',
          ...
          >
            {[
              { value: '1.5M+', label: 'Property Brokers', color: 'emerald' },
              { value: '₹5,000Cr', label: 'Addressable Market', color: 'blue' },
    ...
    <section className="py-28 bg-gradient-to-br from-emerald-600 to-emerald-800 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <Link href="/app" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white text-emerald-700 font-semibold text-lg hover:bg-emerald-50 transition-colors shadow-xl">
            Launch Live Demo <ArrowRight size={18} />
          </Link>
          <div className="mt-8 text-sm text-emerald-200">
            No signup required. Full interactive demo.
          </div>
        </motion.div>
      </div>
    </section>
